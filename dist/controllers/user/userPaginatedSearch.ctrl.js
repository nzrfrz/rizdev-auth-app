...
exports.usersPaginatedSearch = void 0;
const _helpers_1 = require("../../_helpers");
const models_1 = require("../../models");
const usersPaginatedSearch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const allData = yield (0, _helpers_1.getAllDocument)(models_1.USERS, paginatedSearchQuery);
        const paginatedSearchResults = yield (0, _helpers_1.listPaginatedSearch)(models_1.USERS, paginatedSearchQuery, limit, page, per_page);
        ...
        (0, _helpers_1.responseHelper)(res, _helpers_1.status.success, _helpers_1.message.onlySuccess, returnResults);
    }
    catch (error) {
        (0, _helpers_1.responseHelper)(res, _helpers_1.status.errorServer, _helpers_1.message.errorServer, error.toString());
    }
});
exports.usersPaginatedSearch = usersPaginatedSearch;
//# sourceMappingURL=userPaginatedSearch.ctrl.js.map